...
# These commands need to be done bringing up node, on each node.
...
# 1. make sync-external-ip
# 2. make install-calico
# the second has a daemonset to apply this command:
